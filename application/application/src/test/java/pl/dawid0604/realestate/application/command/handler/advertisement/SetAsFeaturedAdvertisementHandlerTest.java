...
class SetAsFeaturedAdvertisementHandlerTest {
    ...
    private SetAsFeaturedAdvertisementHandler handler;

    @BeforeEach
    void setUp() {
        handler = new SetAsFeaturedAdvertisementHandler(advertisementRepository, userRepository);
    }
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        // Given
        final SetAsFeaturedAdvertisementCommand command = getCommand();
    ...
    @DisplayName("Should set as featured")
    void shouldSetAsFeatured(final AdvertisementDetails<?> details) {
        // Given
        final SetAsFeaturedAdvertisementCommand command = getCommand();
        final User foundUser = getDummyUserBuilder().build();
        ...
        verify(foundAdvertisement).setAsFeatured();
    ...
    private static SetAsFeaturedAdvertisementCommand getCommand() {
        return new SetAsFeaturedAdvertisementCommand(
                "abcde", AdvertisementType.FLAT, getDummyEmail());
    }
}
