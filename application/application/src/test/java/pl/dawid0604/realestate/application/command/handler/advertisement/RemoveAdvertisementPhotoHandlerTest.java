...
class RemoveAdvertisementPhotoHandlerTest {
    ...
    private RemoveAdvertisementPhotoHandler handler;

    @BeforeEach
    void setUp() {
        handler = new RemoveAdvertisementPhotoHandler(advertisementRepository, userRepository);
    }
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        // Given
        final RemoveAdvertisementPhotoCommand command = getCommand();
