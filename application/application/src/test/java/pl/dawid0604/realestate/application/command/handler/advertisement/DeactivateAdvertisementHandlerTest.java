...
class DeactivateAdvertisementHandlerTest {
    ...
    private DeactivateAdvertisementHandler handler;

    @BeforeEach
    void setUp() {
        handler =
                new DeactivateAdvertisementHandler(
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        // Given
        final DeactivateAdvertisementCommand command = getCommand();
    ...
    void shouldDeactivate(final AdvertisementDetails<?> details) {
        // Given
        final DeactivateAdvertisementCommand command = getCommand();
        final User foundUser = getDummyUserBuilder().build();
        ...
        verify(foundAdvertisement).deactivate();
    ...
    private static DeactivateAdvertisementCommand getCommand() {
        return new DeactivateAdvertisementCommand("abcde", AdvertisementType.FLAT, getDummyEmail());
    }
}
