...
class DeleteAdvertisementHandlerTest {
    ...
    private DeleteAdvertisementHandler handler;

    @BeforeEach
    void setUp() {
        handler = new DeleteAdvertisementHandler(advertisementRepository, userRepository);
    }
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        // Given
        final DeleteAdvertisementCommand command = getCommand();
    ...
    void shouldDelete(final AdvertisementDetails<?> details) {
        // Given
        final DeleteAdvertisementCommand command = getCommand();
        final User foundUser = getDummyUserBuilder().build();
        ...
        verify(foundAdvertisement).delete();
