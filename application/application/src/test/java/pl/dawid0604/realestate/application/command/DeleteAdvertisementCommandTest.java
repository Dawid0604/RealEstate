...
class DeleteAdvertisementCommandTest {
    ...
    void shouldImplementsCommandInterface() {
        ...
        // When
        // Then
        AnnotationAssertions.assertImplementsCommandInterface(DeleteAdvertisementCommand.class);
    }
    ...
    private static void assertFieldAnnotations(
        ...
        AnnotationAssertions.assertFieldAnnotations(
                DeleteAdvertisementCommand.class, fieldName, requiredAnnotations);
    }
}
