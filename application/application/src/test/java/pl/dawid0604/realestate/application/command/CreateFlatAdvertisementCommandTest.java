...
class CreateFlatAdvertisementCommandTest {
    ...
    void shouldImplementsCommandInterface() {
        ...
        // When
        // Then
        AnnotationAssertions.assertImplementsCommandInterface(CreateFlatAdvertisementCommand.class);
    }
    ...
    private static void assertFieldAnnotations(
        ...
        AnnotationAssertions.assertFieldAnnotations(
                CreateFlatAdvertisementCommand.class, fieldName, requiredAnnotations);
    }
}
