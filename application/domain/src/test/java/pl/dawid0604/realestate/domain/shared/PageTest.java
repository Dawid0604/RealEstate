...
class PageTest {
    ...
    final class EmptyMethodTests {
        ...
        void shouldCreateInstanceAndReturnSameValues(final int page, final int pageSize) {
            // Given
            // When
            final Page<?> instance = Page.empty(page, pageSize);

            // Then
            Assertions.assertThat(instance).isNotNull();
            Assertions.assertThat(instance.getPageNumber()).isEqualTo(page);
        ...
        void shouldThrowExceptionWhenPageIsInvalid(final Integer page) {
            ...
            // When
            // Then
            Assertions.assertThatThrownBy(() -> Page.empty(page, 25))
        ...
        void shouldThrowExceptionWhenPageSizeIsInvalid(final Integer pageSize) {
            ...
            // When
            // Then
            Assertions.assertThatThrownBy(() -> Page.empty(1, pageSize))
                    .isExactlyInstanceOf(IllegalArgumentException.class)
    ...
    void shouldSetEmptyListWhenItemsListIsNull() {
        // Given
        // When
        final Page<String> instance = Page.of(null, 0, 25, 0);
    ...
    void shouldThrowExceptionWhenPageIsInvalid(final int page) {
        ...
        // When
        // Then
        Assertions.assertThatThrownBy(() -> Page.of(List.of(), page, 25, 0))
                .isExactlyInstanceOf(IllegalArgumentException.class)
                .hasMessage("Page number cannot be negative");
    }
    ...
    void shouldThrowExceptionWhenPageSizeIsInvalid(final int pageSize) {
        ...
        // When
        // Then
        Assertions.assertThatThrownBy(() -> Page.of(List.of(), 1, pageSize, 0))
                .isExactlyInstanceOf(IllegalArgumentException.class)
                .hasMessageStartingWith("Page size must be between ");
    }
    ...
    void shouldThrowExceptionWhenTotalElementsIsInvalid(final int totalElements) {
        ...
        // When
        // Then
        Assertions.assertThatThrownBy(() -> Page.of(List.of(), 1, 25, totalElements))
                .isExactlyInstanceOf(IllegalArgumentException.class)
    ...
    void shouldCreateInstanceWithBoundaryPageSizeValue(final int pageSize) {
        // Given
        // When
        final Page<String> instance = Page.of(List.of(), 0, pageSize, 0);
    ...
    void shouldCreateInstance() {
        ...
        // When
        final Page<String> instance = Page.of(items, page, pageSize, totalElements);
    ...
    void shouldReturnProperHasNextValue(final int page, final boolean expectedValue) {
        ...
        // When
        final Page<String> instance = Page.of(items, page, 25, 50);
