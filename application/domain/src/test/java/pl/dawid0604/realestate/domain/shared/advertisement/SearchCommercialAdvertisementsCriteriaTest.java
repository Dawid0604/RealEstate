...
class SearchCommercialAdvertisementsCriteriaTest {
    ...
    void shouldCreateInstance() {
        ...
        // When
        final var criteria =
                new SearchCommercialAdvertisementsCriteria(
                        areaFrom,
                        areaTo,
                        priceFrom,
                        priceTo,
        ...
        Assertions.assertThat(criteria)
                .satisfies(
                        c -> {
                            ...
                            Assertions.assertThat(c.floorFrom()).isEqualTo(floorFrom);
                            Assertions.assertThat(c.floorTo()).isEqualTo(floorTo);
