...
import pl.dawid0604.realestate.api.validation.ValidNotificationEmail;
import pl.dawid0604.realestate.api.validation.ValidNotificationPhoneNumber;
...
public record UpdateUserProfileRequest(
        ...
        @Schema(description = "Avatar url", example = "https://anyImage.com/avatar.png")
                String avatarUrl,
        @ValidNotificationEmail
                @Schema(description = "Notification email", example = "anyMail@mail.com")
                String notificationEmail,
        @ValidNotificationPhoneNumber
