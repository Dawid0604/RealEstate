...
@RequestMapping(value = "/api/advertisement/flat")
@Tag(name = "Flat advertisement", description = "Flat advertisements management")
class FlatAdvertisementController {
    ...
    void create(
            @Validated @RequestBody final CreateFlatAdvertisementRequest request,
    ...
    @ApiResponse(responseCode = "404", description = "User not found")
    void update(
            @Validated @RequestBody final UpdateFlatAdvertisementRequest request,
            @AuthenticationPrincipal final AuthenticatedUser loggedUser) {
    ...
    void searchByCriteria(@Validated @RequestBody final SearchFlatAdvertisementsRequest request) {
        queryBus.send(
    ...
    @ApiResponse(
            ...
            content =
                    @Content(schema = @Schema(implementation = FlatAdvertisementDetailsDto.class)))
